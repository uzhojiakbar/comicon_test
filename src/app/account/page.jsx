                                ...
                                <>
                                    <div className={styles.boxOneTicket}>
                                        ...
                                        <div className={styles.boxTicketAndMpInfo}>
                                            <div className={styles.boxOneInfo}>99.0001</div>
                                ...
                                <>
                                    ...
                                    <div className={styles.boxColQrCode}>
                                        <div className={styles.boxQr}>
                                            <Image src="/qrcodeAccount.svg" alt="qrcode" width={314} height={314}/>
                                        </div>
                                        <button onClick={() => setAccount("tickets")} className={styles.boxBtnBack}>
